# RIPE Internet Dataset Descriptions

This repository contains descriptions of some of the RIPE NCC datasets. The
goal of this repository is to document the artefacts present in the datasets
that are relevant for (academic) researchers that consume these datasets.
...
data (for example on RIPE Atlas) that is not (yet) described here.
